...
#load the groq api key and openai apikey
os.environ["OPENAI_API_KEY"] = os.getenv("OPENAI_API_KEY")
groq_api_key = os.getenv("GROQ_API_KEY")

st.title("Chat groq with LLama 3")
...
def vector_embedding():
    if "vectors" not in st.session_state:
        ...
        st.session_state.vectors=FAISS.from_documents(st.session_state.final_docs, st.session_state.embeddings) #vector openAI embeddings
